...
function run(ctrlDevice, options)
{
  return new Promise((resolve, reject) => {
    let fxvalue = typeof options.fxvalue == "undefined" ? 0x45 : options.fxvalue;
    fxvalue = Math.max(1, Math.min(69, fxvalue));
    let checksum = 53028 - (69 - fxvalue);
    ...
    sleep()
      ...
      //Send next config
      .then(() => {
        console.log(fxvalue, b);
        
        writeControl(ctrlDevice, [
            0x0d, 0xbb, 0x01, 0x00, 0x06, 0x0b, 0x05, fxvalue, 0x83, 0xca, 0xca, 0xca,
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, b[0], b[1],
        ]);
        return sleep()
      })
